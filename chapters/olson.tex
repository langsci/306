...
Second, the positioning of /ɪ/ and /ʊ/ in the plot generally corresponds to what we expect for high [–\textsc{atr}] vowels. In Starwalt's (\citeyear{Starwalt2008}) crosslinguistic study of the acoustics of \textsc{atr} vowel harmony \is{\textsc{atr} harmony} systems, she found that the \textit{F}\textsubscript{2} of /ʊ/ is consistently lower than the \textit{F}\textsubscript{2} of /o/ for the \ili{African languages} she studied (although this was not always statistically significant) -- \textit{Kwa} \il{Kwa languages}: \ili{Foodo} [fod] and \ili{Ikposo} [kpo] -- \textit{Bantu} \il{Bantu languages}: \ili{Kinande} [nnb] and \ili{LuBwisi} [tlj] -- \textit{Defoid} \il{Defoid languages}: \ili{Ekiti-Yoruba} [yor]. The positioning of /ʊ/ vis-à-vis /o/ in \figref{fig:olson:1} is consistent with this.
