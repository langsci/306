...
Focus can also be broad or narrow depending on whether it is assigned to the entire sentence (or its truth value) or a particular constituent or complement \citep[44]{DikVanderHulst1981}. See the Līkpākpáln (Līchábͻ́l) sentences in \REF{ex:bisilki:6} and \REF{ex:bisilki:7}:
