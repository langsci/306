...
\ea
    ...
    \ex \label{ClauseCompl}
        ...
        \glt    `I know that Numi is hungry.'\todo{Person and number information should not be separated by a period, per Leipzig GR}
    \end{xlist}
\z
...
\textsc{recp} = reciprocal\todo{Abbreviation changed per LGR}
