...
\begin{figure}%32
\caption{\color{red}Please provide a caption\label{fig:fromex:newkirk:32}}
...
\begin{figure}%33
    \caption{{\color{red}Please provice a caption}\label{fig:fromex:newkirk:33}}
    \resizebox{\textwidth}{!}{\begin{forest}
    fairly nice empty nodes
    [TP
...
\begin{figure}%39
\caption{\color{red}Please provide a caption\label{fig:fromex:newkirk:39}}
\begin{forest}
fairly nice empty nodes
% [TP
	% [DP,name=specTP [Jack,name=Jack,roof] ]
...
\begin{figure}%40
    \caption{\color{red}Please provide a caption\label{fig:fromex:newkirk:40}}
\resizebox{\textwidth}{!}{\begin{forest}
fairly nice empty nodes
% [TP
	% [DP,name=specTP [Jack,name=Jack,roof] ]
