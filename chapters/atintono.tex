...
\ChapterDOI{10.5281/zenodo.6393803}

\author{Samuel Awinkene Atintono\affiliation{Accra College of Education}}
\title[Lessons from the field]{Lessons from the field: An insight into the documentation of Gurenɛ oral genres}  
...
\section{Introduction}\label{sec:atintono:1}
...
\section{The audio and video corpus}\label{sec:atintono:5}\largerpage
...
\caption{A traditional court trial on land dispute at the Bongo Chief’s Palace with the chief seated 
...
\section{Conclusion}\label{sec:atintono:8}
