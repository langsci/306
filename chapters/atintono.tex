...
\fittable{
   	...
   	\begin{tabularx}{\textwidth}{Xrrrr}
   		\lsptoprule
       \textbf{Genre} & \textbf{Length} & \textbf{Transcription} & \textbf{Archived} & \textbf{Count} \\ 
        & hh:mm & hh:mm & hh:mm &  \\ \midrule
   		...
   		\textbf{Total}                    & \textbf{63:50}        & \textbf{33:05}               & \textbf{25:00}            & \textbf{830}  \\
   		\lspbottomrule
   	\end{tabularx}
 	...
 	%\begin{tabular}{p{2.5cm} p{2.5cm} p{1cm} p{2.5cm} p{2.5cm}  }
       ...
       \textbf{Genre} & \textbf{Length} & \textbf{Transcription} & \textbf{Archived} & \textbf{Count} \\ 
        & hh:mm & hh:mm & hh:mm &  \\ \midrule
 	    	...
 	    	\textbf{Total}                          & 35:15           & 18:35                & 15:55                  & 555               \\
 	    	\lspbottomrule
 	    \end{tabularx}
