...
\ea
	...
	\glt    `You should drink, hm, ancestors of this country of Mokiri, mh.' (1/61)}
	\ex[]{
    \gll    Akiye ká mókiri hḿ  ǹte ɗě iyu\\
   			Akiye.A \textsc{gen} Mokiri.A hm exist \textsc{dm} here\\
    \glt    `Akiye of Mokiri, mh, exist here.' (1/62)}
	\ex[]{
 	\gll    hḿ kɔ nɪyɛ ɗě ni kíí ntei-yak nen iyû nkúyaki hm\\
    	    hm \textsc{cop} \textsc{3.sg.a} \textsc{dm} \textsc{rel.sg} be.together \textsc{prep} here Nkuyaki hm\\
    \glt    `Hm, it is him who we were all together with here in Nkuyaki, hm.' (1/63)}
	\ex[]{
    \gll    inkúyaki ɗe ko inkúyaki ɗe ni hḿ\\
    	    Inkuyaki \textsc{dm-cop} Inkuyaki.\textsc{a} \textsc{dm} \textsc{d.pr.sg} hm\\
     \glt   `It is inkuyaki there, hm.' (1/64)}
	\ex[]{
    ...
    \glt    `We say: Hm. You who are Kikeko folks, hm, should gather all together.' (1/65)}
	\ex[]{
    \gll    ɛlá kɔlɔ  hḿ iciɗeí kaai táá kisíko hḿ kai táá kisíko hḿ\\
            folks \textsc{excl} hm here town.\textsc{a} \textsc{gen} Kisiko.\textsc{a} \textsc{gen} Kisiko.\textsc{a} hḿ\\
    \glt    `Folks, hm, here the town of Kisiko, hm.' (x2)' (1/66)}
    \z
\z
