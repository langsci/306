...
\abstract{%Tense and aspect have different distributions in Akan SVCS: we mark tense on all verbs, while aspect and marked on the first verb while co
...
\shorttitlerunninghead{Tense and aspect in Akan serial verb constructions}  
\begin{document}
	\shorttitlerunninghead{Tense and aspect in Akan serial verb constructions}  
\maketitle
...
\ea\label{ex01} 
\gll Kofi to-\textbf{o} bo\textipa{O} k\textipa{O}-\textipa{\textbf{O}} dan no mu. \\
...
\gll * Kofi to-o bo\textipa{O}  k\textipa{O} dan no mu.\\
	{} Kofi throw-\textsc{pst} stone  go.\textsc{pres} room \textsc{def} PostP\\
\z 
\ex\label{ex3}
\textbf{$\ast$ \phantom {} {} {}  V(Pst)\phantom {} {} {}   V(Asp)} 
     \ea\label{ex0001} 
\gll * Kofi to-\textbf{o} bo\textipa{O}  \textbf{re}-k\textipa{O} dan no mu.\\
...
\gll Kofi \textbf{re}-to bo\textipa{O} \textbf{\`a}-k\textipa{O} dan mu.\\
...
\textbf{$\ast$ \phantom {} {} {}  V(Asp)\phantom {} {} {}   V(Asp)} 
     \ea\label{ex07} 
\langinfo{Akan}{}{Personal knowledge} \\
\gll * Kofi re-to bo\textipa{O} re-k\textipa{O}-\textipa{O} dan mu.\\
...
\textbf{$\ast$ \phantom {} {} {}  V(Asp)\phantom {} {} {}   V(Past)} 
     \ea\label{ex7} 
\langinfo{Akan}{}{Personal knowledge} \\
\gll * Kofi re-to bo\textipa{O} k\textipa{O}-\textipa{O} dan mu.\\
...
\gll Ekpe \textbf{a} \texthtbardotlessj o k\textipa{O}po yi x\textipa{O}-me.\\
...
\z Tense attaches to neither of the verbs. The distribution of the tense morpheme in Ewe is in assonance with \citepos{BakerStewart2002} observation that most in most SVC languages there is no feature checking between the T and v thus no tense morphology on the verb.\\
...
\ea  \gll \`o d\`a s\textipa{\'E} la n\textipa{\'E}n\`e \textipa{\`O}\textipa{\`O}.\\
	3\textsc{sg} \textsc{pst} roast F meat eat\\
\glt`He roasted meat and ate it.'
    
\ex 
\gll * \`o d\`a s\textipa{\'E} la  \textipa{\`O}\textipa{\`O} n\textipa{\'E}n\`e.\\
...
\ea \label{ex28}  \gll  Kofi kye-e ab\textipa{O}fra no bo-o no.\\
...
\ea \label{ex011}
\ea \label{ex011a} \gll Kofi t\textipa{O}-\textipa{O} aduane di-i.\\
	Kofi buy-\textsc{pst} food eat-\textsc{pst}\\
	\glt `Kofi bought food to eat.'
    
    \ex\label{ex011b} \gll * Kofi t\textipa{O}-\textipa{O} aduane re-di.\\
	{} Kofi buy-\textsc{pst} food \textsc{prog}-eat\\
	
 \z \z I argue the tense restriction we see in SVCs is a result of this single T projection simultaneously Agreeing with all verbs. To account for the relation between the single tense projection and the multiple verbs in SVCs, I adopt \citepos{PesetskyTorrego2007} theory of Agree, and an adaption of \citeauthor{Hiraiwa2001}'s \citeyearpar{Hiraiwa2001} Multiple Agree. Since Multiple Agree is defined for goals that are in a c-command relation, I defined  \textbf{Parallel Agree} to account for the SVCs context where there is no c-command between the goals.\\ Agree, according to \citet{PesetskyTorrego2007},  is feature sharing. They argue that agreement involves features of lexical items that differ as to whether they are valued/unvalued and interpretable/uninterpretable.  
  
  \ea\label{ex23}
   \begin{tabular}{l  l  l  l }\lsptoprule
  	& Interpretable & Uninterpretable\\\midrule
  	Valued & [iF:F] & [uF:F]\\\midrule
  	Unvalued & [iF:] & [uF:]\\\lspbottomrule
  \end{tabular}
...
\begin{center}
	\begin{tikzpicture}
		\Tree [.a [.\node(A) {$\alpha$}; ] [.b [.c [.e ] [. \node(B) {$\beta$}; ] ] [.d [.f ] [.\node(Y) {$\gamma$}; ] ] ] ]
	\draw[->](A)..controls +(south west:1) and +(west:1)..(B);
	\draw[->](A)..controls +(south west:5) and +(west:1)..(Y);
	\end{tikzpicture} 
\end{center}
...
\ea\label{ex041} 
\gll Kofi re-to bo\textipa{O} \`a-k\textipa{O} dan mu.\\
	Kofi \textsc{prog}-throw stone \textsc{cons}-go room PostP\\
	 \\
\glt `Kofi is throwing a stone for it to go into the room.'
\z 
...
\begin{tikzpicture}[scale=0.6]	
	...
	[.T ] [.NegP [.Neg ] [.OAspP [.OAsp\\re ] [.\node(110){VoiceP+prog,-fut}; [.DP ] [.\node (105){Voice'+prog,-fut}; [.Voice ] [.\node (V)  {vP+prog,-fut};
	 [.\node (102){vP+prog,-fut}; [.v\\to ] [.\node (101){IAspP+prog,-fut}; [.\node (100){IAsp\\{[+prog,-fut]}}; ] [.VP [.V ] [.DP\\bo\textipa{O} ] ] ] ]  [.v' [.\node (V2)  {v}; $\emptyset$ ]  [.\node (vpp) {vP{-prog,-fut}}; [.v ] [.\node (ok){IAspP{-prog,-fut}\\}; [.\node (okk){IAsp\\{[-prog,-fut]}}; ] [.VP [.V\\k\textipa{O} ] [.PP [.DP [.NP\\dan ] [.D\\no ] ] [.P\\mu ] ] ] ] ]
	  ] ] ]
	 ] ] ]
	] ]
	\draw[dashed,-> ] (100.west) to [bend left=90] (101.west);
	%\draw[->](100)..controls +(south west:2) and +(west:2)..(101)node[near end, left] {\scriptsize feature percolation};
	\draw[dashed,-> ] (101.north) to [bend right=90] (102.east);
	\draw[dashed,-> ] (102.west) to [bend left=45] (V.west);
	\draw[dashed,-> ] (V.north) to [bend right=45] (105.east);
	\draw[dashed,-> ] (105.north) to [bend right=45] (110.east);
    \draw[dashed,-> ] (okk.west) to [bend left=90] (ok.west);
    \draw[dashed,-> ] (ok.west) to [bend left=45] (vpp.west);
...
\todo[inline]{Please verify that you intend to cite \citet{Boskovic1997Book} and not \citet{Boskovic1997Wh}.}
...
\ex *re (+prog, -fut) + b\textipa{E} (-prog, +fut)
