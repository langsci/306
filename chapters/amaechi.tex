...
\ea%3
    ...
    \gll    Òbí hụ̀rụ̀ Àdá n'-áhíá\\
            Obi saw Ada P-market\\
    \glt    `\textsc{Òbí} saw Àdá at the market.' \hfill\textit{\small SBJ  focus}}
    \z
\z
...
\ea%7
    ...
    % \glt    `Úchè thinks that Òbí saw Àdá \textsc{At the market} .' \hfill\textit{\small long ADJ focus}
    \z
\z
...
%\glt `Who did Òbí see at the market?'\hfill\textit{\small DO question}
%\ex
%\gll Àdá \textbf{*(kà)} Òbí hụ̀rụ̀ {\longrule}   n'-áhíá\\
%Ada \textsc{foc} Obi saw {} P-market\\
%\glt `Obi saw \textsc{Ada} at the market.' \hfill\textit{\small DO focus, new information}
%\z
%\z
...
%no Ada \textsc{foc} Obi saw {} P-market\\
%\glt `No, Òbí saw \textsc{Úchè} at the market.' \hfill\textit{\small DO focus, corrective}
%\z
%\z
...
%\glt `Òbí saw Àdá at the market but Úchè saw \textsc{{\`U}g{\'o}} at the market.'\\\vspace*{-0.2cm}\phantom{~}\hfill\textit{\small DO focus, contrastive}
%\z
...
%\glt `Àdá saw \textsc{Òbí}. And (she saw) \textsc{Úchè}, too.' \hfill{\textit{ex-situ DO focus}}
%\ex
%\gll Ọ́ bụ̀ Òbí kà Àdá hụ̀rụ̀. \# Ọ́ hụ̀-kwà-rà  Úchè.\\
%it \textsc{cop} Obi \textsc{foc} Ada saw {} it see-also-\textsc{pst} Uche\\
%\glt `It is \textsc{Òbí} who Àdá saw. And (she saw) \textsc{Úchè}, too.'\hfill{\textit{DO focus, cleft}}
%\z
%\z
...
\ea%11
    ...
    \glt    `Who saw Àdá at the market?' \hfill\textit{\small wh-SBJ, in-situ}}
    \ex[]{\label{ex:amaechi:11b}
    \gll    Òbí hụ̀rụ̀ ònyé n'-áhíá\\
            Obi saw who P-market\\
    \glt    `Who did Òbí see at the market?' \hfill\textit{\small wh-DO, in-situ}}
    \ex[*]{\label{ex:amaechi:11c}
    \gll    Ònyé kà hụ̀rụ̀ Àdá n'-áhíá\\
            who \textsc{foc} saw Ada P-market\\
    \glt    `Who saw Àdá at the market?' \hfill\textit{\small wh-SBJ, ex-situ}}
    \ex[]{\label{ex:amaechi:11d}
    \gll    Ònyé *({kà}) Òbí hụ̀rụ̀ n'-áhíá\\
            who \textsc{foc} Obi saw P-market\\
    \glt    `Who did Òbí see at the market?' \hfill\textit{\small wh-DO, ex-situ}}
    \ex[]{\label{ex:amaechi:11e}
    \gll    Ọ̀ bụ̀ ònyé hụ̀rụ̀ Àdá\\
            it \textsc{cop} who saw Ada\\
    \glt    `Who saw Àdá?' \hfill\textit{\small wh-SBJ, cleft}}
    \ex[]{\label{ex:amaechi:11f}
    \gll    Ọ̀ bụ̀ ònyé *(kà) Òbí hụ̀rụ̀\\
            it \textsc{cop} who \textsc{foc} Obi saw\\
    \glt    `Who did Òbí see?' \hfill\textit{\small wh-DO, cleft}}
    \z
\z
