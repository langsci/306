...
\begin{xlist}
\ex{
\gll Mb\textit{û}zi zi-na-p\textit{í}nd-\textit{á} m\textit{ă}ta.\\
10.goats 10\textsc{sm-pst}-bend-a 6.bows \\
\glt `The goats bent the bows.'
}
\ex{ 
\gll Ma-\textit{ŭ}ta a-na-p\textit{í}nd-\textit{í}dw-\textit{á} nd\textit{í} mb\textit{û}zi. \\
6-bows 6-\textsc{sm-pst}-bend-\textsc{pass-fv} by 10.goats    \\
\glt `The bows were bent by the goats.'
}
\ex{ 
\gll Ma-\textit{ŭ}ta a-na-p\textit{í}nd-\textit{í}k-a (*nd\textit{í} mb\textit{û}zi).\\
6-bows 6-\textsc{sm-pst}-bend-\textsc{pass-fv} (*by 10.goats)\\
