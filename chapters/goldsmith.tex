...
%\newcommand{\textcolor{red}}{{\color{red}TM}}
...
\shorttitlerunninghead{Learning Swahili Morphology}
\begin{document}
\shorttitlerunninghead{Learning Swahili Morphology}
\maketitle
